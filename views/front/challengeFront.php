...
/**
 * @category   Challenge data front view.
...
class ClubMembersChallengeFront extends ChallengeView {

    /**
     * ClubMembersChallengeFront constructor
     * @param string $index
     */
    public function __construct($club_index, $login, $password, $exclusions)
    {
